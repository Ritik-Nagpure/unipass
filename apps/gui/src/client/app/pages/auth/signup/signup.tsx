...
interface SignupProps {
  onModeChange: (mode: 'identify' | 'login') => void;
}

const Signup: React.FC<SignupProps> = ({ onModeChange }) => {
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
        ...
        <div className="hidden lg:block">
          <div className="max-w-lg">
            ...
            <div className="mt-8 bg-bg-secondary rounded-xl border border-border p-6">
              <p className="text-sm text-text-secondary leading-relaxed">
                <span className="text-primary font-semibold">💡 Pro Tip:</span> Use a strong, 
                unique password that you haven't used elsewhere. Your security starts here.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-start-2">
          <div className="bg-card-bg rounded-2xl border border-border p-6 md:p-8 shadow-card max-w-md mx-auto lg:mx-0 w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-text-primary mb-1" htmlFor="signup-name">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-text-primary mb-1" htmlFor="signup-confirm">
                  Confirm Password
                </label>
                <input
                  type={showPassword ? 'text' : 'password'}
              ...
              <div className="flex items-start gap-2">
                ...
                />
                <label htmlFor="signup-terms" className="text-sm text-text-secondary cursor-pointer">
                  I agree to the 
                  <Link to="/terms-of-service" className="text-primary hover:underline mx-1">Terms of Service</Link>
                  and 
